...
class simulation_model():
    def __init__(self):
        ...
        'infectiousPopulationI'          : lambda t: ( (2.0) if ( t  <=  self.starttime ) else (self.memoize('infectiousPopulationI',t-self.dt) + self.dt * ( self.memoize('infectionRateIr',t-self.dt) )) ),
        ...
        self.stocks = ['infectiousPopulationI',   'susceptiblePopulationS'  ]
        self.flows = ['infectionRateIr'  ]
        self.converters = ['contactRateC',   'infectivityI',   'totalPopulationN'  ]
        self.gf = []
        self.constants= []
        self.events = [
            ]
